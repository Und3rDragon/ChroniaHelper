...
teraZipMover.name = "ChroniaHelper/teraZipMover"
teraZipMover.depth = -9999
teraZipMover.nodeVisibility = "never"
teraZipMover.nodeLimits = {1, 1}
teraZipMover.minimumSize = {16, 16}
teraZipMover.fieldInformation = {
    theme = {
        options = themes,
        editable = false
    },
...
teraZipMover.placements = {}

for i, theme in ipairs(themes) do
    teraZipMover.placements[i] = {
        name = "TeraLite - Zip Mover (" .. theme .. ")",
        data = {
            width = 16,
            height = 16,
            theme = theme,
...
function teraZipMover.sprite(room, entity)
    local sprites = {}
...
function teraZipMover.selection(room, entity)
    local x, y = entity.x or 0, entity.y or 0
