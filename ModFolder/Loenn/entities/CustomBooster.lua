...
booster.fieldInformation = {
	...
	directory = {
		options = {
			...
			"objects/ChroniaHelper/customBoosterPresets/blue",
			"objects/ChroniaHelper/customBoosterPresets/orange",
			"objects/ChroniaHelper/customBoosterPresets/cyan",
			"objects/ChroniaHelper/customBoosterPresets/lavender",
			"objects/ChroniaHelper/customBoosterPresets/lightGreen",
		},
		editable = true,
	},
	colorOverlay = {
