...
[Tracked(true)]
[CustomEntity("ChroniaHelper/FntDisplayZoneHD")]
public class FntDisplayZoneHD : HDRenderEntity
{
    public FntDisplayZoneHD(EntityData d, Vc2 o) : base(d, o)
    {
        ...
        renderer = new FntTextGroupHD(template, d.Attr("textures", "ChroniaHelper/MinecraftTestFont/minecraft").Split(',',StringSplitOptions.TrimEntries));
