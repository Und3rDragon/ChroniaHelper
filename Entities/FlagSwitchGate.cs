...
namespace ChroniaHelper.Entities {
    ...
    /// </summary>
    [CustomEntity("ChroniaHelper/FlagSwitchGate")]
    [Tracked]
    public class FlagSwitchGate : Solid {
        ...
        public FlagSwitchGate(EntityData data, Vector2 offset)
            ...
            icon = new Sprite(GFX.Game, iconAttribute == "vanilla" ? "objects/switchgate/icon" : $"objects/ChroniaHelper/flagSwitchGate/{iconAttribute}/icon");
            Add(icon);
