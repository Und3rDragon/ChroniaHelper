...
[Tracked(false)]
[CustomEntity("ChroniaHelper/ZipWater")]
public class ZipWater : OmniZipSolid
{
    ...
    public ZipWater(EntityData data, Vector2 offset)
    ...
    public override void Update()
    {
        ...
        {
            surface.Position = Position + new Vector2(Width / 2f, 8);
            surface.Update();
        }
