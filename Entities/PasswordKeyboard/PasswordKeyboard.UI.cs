...
partial class PasswordKeyboard
{
    public sealed class UI : Entity
    {
        ...
        private void DrawExtraUI()
        {
            ...
            if (Md.Session.Passkeyboard_RemainingUses[config.entityID] > 0)
            {
                DrawOptionText($"You have {Md.Session.Passkeyboard_RemainingUses[config.entityID]} chances left",
            ...
            else if(Md.Session.Passkeyboard_RemainingUses[config.entityID] == 0)
            {
