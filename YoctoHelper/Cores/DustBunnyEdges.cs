...
public class DustBunnyEdges : Entity
{
    ...
    public void BeforeRender()
    {
        ...
        foreach (Color color in ChroniaHelperModule.Session.EdgeColorDictionary.Keys)
        {
            ...
            foreach (DustBunnyEdge dustBunnyEdge in ChroniaHelperModule.Session.EdgeColorDictionary[color])
            {
